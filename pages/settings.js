...
const settings = ({navigation}) => {
  return (
    <View style={styles.center}>
      ...
      <Text style={{textAlign:'center',fontSize:20,justifyContent:'center',alignItems:'center',marginTop:hp('16%'),marginLeft:wp('15%')}}>This page is Button for posting Screen</Text>
